...
const VerifyOtp = () => {
  ...
  return (
    <div className="main-layout w-full ">
      ...
      <div className="min-h-screen flex flex-col justify-center py-12 pt-20 sm-px-12 lg-px-8 bg-gradient-to-b from-gray-50 to-gray-100 dark-from-gray-900 dark-to-gray-800">
        ...
        <div className="mt-8 sm-mx-auto sm-w-full sm-max-w-md">
          <div className="bg-white dark-bg-gray-800 py-8 px-4 shadow sm-rounded-xl sm-px-10 border border-gray-100 dark-border-gray-700">
            {status && (
              <div className="mb-4 text-sm font-medium text-green-700 dark-text-green-400 bg-green-50 dark-bg-green-900-20 rounded-lg p-4 flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-400 dark-text-green-300 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            {error && (
              <div className="mb-4 text-sm font-medium text-red-700 dark-text-red-400 bg-red-50 dark-bg-red-900-20 rounded-lg p-4 flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-400 dark-text-red-300 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="otp_1" className="block text-sm font-medium text-gray-700 dark-text-gray-300 mb-1">
                ...
                <p className="mt-2 text-xs text-gray-500 dark-text-gray-400">Nous vous avons envoyé un code à 6 chiffres par email. Ce code est valide pendant 10 minutes.</p>
              </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark-bg-gray-800 text-gray-500 dark-text-gray-400">Vous n'avez pas reçu de code?</span>
                </div>
              </div>
            ...
            <div className="mt-6 text-center">
              <a href="/login" className="text-sm text-primary-600 hover-text-primary-500 dark-text-primary-400 dark-hover-text-primary-300 font-medium flex justify-center items-center">
